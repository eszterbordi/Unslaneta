...
%RÉSZFELADATOK 2
% % % % % % % % % % % % % % % % % % % % % % % % %
\begin{frame}{Munkabeosztás és ütemterv II}
Munkaegységek és részfeladatai:
\begin{itemize}
  \item<1-> {
...
\begin{frame}{Gantt-diagram I}
	...
	\gantttitle{II. félév}{14} \\
	\gantttitlelist{1,...,14}{1} \\
	\ganttset{progress label text={}, link/.style={black, -to}} \\
	\ganttgroup[group label node/.append style={align=right}]{A kutatás beindítása, \ganttalignnewline adatgyűjtés}{1}{6} \\
	\ganttbar[progress=100,bar progress label font=\tiny\color{OliveGreen!75},
		bar progress label node/.append style={right=4pt},
		bar label node/.append style={align=right}]
	{Kutatási módszertani \ganttalignnewline lehetőségek felvázolása}{1}{3} \\
	
	\ganttbar[progress=100,bar progress label font=\tiny\color{OliveGreen!75},
		bar progress label node/.append style={right=4pt},
		bar label node/.append style={align=right}]
	{Kutatási terv kidolgozása}{1}{5} \\
	
	\ganttbar[progress=100,bar progress label font=\tiny\color{OliveGreen!75},
		bar progress label node/.append style={right=4pt},
		bar label node/.append style={align=right}]
	{Meglévő módszerek \ganttalignnewline feltérképezése}{4}{6} \\
	
	\ganttbar[progress=100,bar progress label font=\tiny\color{OliveGreen!75},
		bar progress label node/.append style={right=4pt},
		bar label node/.append style={align=right}]
	{Prototípus első \ganttalignnewline koncepciójának kidolgozása}{6}{6} \\
	
	\ganttgroup[group label node/.append style={align=right}]{Az adathalmaz összeállítása}{7}{8} \\
	\ganttbar[progress=50,bar progress label font=\tiny\color{OliveGreen!75},
		bar progress label node/.append style={right=4pt},
		bar label node/.append style={align=right}]
	{Adatok gyűjtése}{7}{7} \\
	...
	\ganttbar[progress=50,bar progress label font=\tiny\color{OliveGreen!75},
		bar progress label node/.append style={right=4pt},
		bar label node/.append style={align=right}]
	{Standard formátumra való \ganttalignnewline alakítás}{7}{7} \\
		
	\ganttbar[progress=0,bar progress label font=\tiny\color{OliveGreen!75},
		bar progress label node/.append style={right=4pt},
		bar label node/.append style={align=right}]
	{Adathalmaz validálása}{8}{8} \\
...
\begin{frame}{Gantt-diagram II}
	...
	\gantttitlelist{1,...,14}{1} \\
	\ganttset{progress label text={}, link/.style={black, -to}} \\
	\ganttgroup[group label node/.append style={align=right}]{Algoritmus kidolgozása}{9}{11} \\
	\ganttbar[progress=0,bar progress label font=\tiny\color{OliveGreen!75},
		bar progress label node/.append style={right=4pt},
		bar label node/.append style={align=right}]
	{Algoritmus leírása}{9}{9} \\
	
	\ganttbar[progress=0,bar progress label font=\tiny\color{OliveGreen!75},
		bar progress label node/.append style={right=4pt},
		bar label node/.append style={align=right}]
	{Teszt jegyzőkönyvek,\ganttalignnewline az SMT hatékonyságával\ganttalignnewline kapcsolatos hatások vizsgálata}{10}{11} \\
	
	\ganttgroup[group label node/.append style={align=right}]{Az új és régi módszerek\ganttalignnewline összevetése}{10}{13} \\
	
	\ganttbar[progress=0,bar progress label font=\tiny\color{OliveGreen!75},
		bar progress label node/.append style={right=4pt},
		bar label node/.append style={align=right}]
	{Tesztfuttatások különböző \ganttalignnewline algoritmusokkal}{10}{11} \\
	
	\ganttbar[progress=0,bar progress label font=\tiny\color{OliveGreen!75},
		bar progress label node/.append style={right=4pt},
		bar label node/.append style={align=right}]
	{Az eltérés statisztikus\ganttalignnewline validációja}{11}{13} \\
...
\begin{frame}{Gantt-diagram III}
	...
	\gantttitlelist{1,...,14}{1} \\
	\ganttset{progress label text={}, link/.style={black, -to}} \\
	\ganttgroup[group label node/.append style={align=right}]{Az algoritmus optimalizálása,\ganttalignnewline prototípus-fejlesztés}{12}{14} \\
			
		\ganttbar[progress=0,bar progress label font=\tiny\color{OliveGreen!75},
			bar progress label node/.append style={right=4pt},
			bar label node/.append style={align=right}]
		{Performanciaoptimalizált \ganttalignnewline algoritmus}{12}{12} \\
			
		\ganttbar[progress=0,bar progress label font=\tiny\color{OliveGreen!75},
			bar progress label node/.append style={right=4pt},
			bar label node/.append style={align=right}]
		{A gépi fordító prototípusának \ganttalignnewline tesztelése és tesztjegyzőkönyvek}{12}{13} \\
		
		\ganttbar[progress=0,bar progress label font=\tiny\color{OliveGreen!75},
				bar progress label node/.append style={right=4pt},
				bar label node/.append style={align=right}]
		{Nyilvánosságra hozandó \ganttalignnewline eredmények dokumentációja}{13}{14} \\
		
		\ganttbar[progress=0,bar progress label font=\tiny\color{OliveGreen!75},
				bar progress label node/.append style={right=4pt},
				bar label node/.append style={align=right}]
		{A projekt lezárása,\ganttalignnewline dokumentáció}{14}{14} \\
\end{ganttchart}
\end{frame}